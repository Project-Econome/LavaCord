...
import { CompiledFunction } from "@tryforge/forgescript/src/structures/@internal/CompiledFunction";
import { Container, Sendable } from "@tryforge/forgescript/src/structures/@internal/Container";
import { IArg, UnwrapArgs } from "@tryforge/forgescript/src/structures/@internal/NativeFunction";
import { Return } from "@tryforge/forgescript/src/structures/@internal/Return";
import { IRunnable } from "@tryforge/forgescript/src/core/Interpreter";
...
export declare class Context {
    ...
    get client(): import("@tryforge/forgescript/src").ForgeClient;
    set obj(o: Sendable);
    get cmd(): import("@tryforge/forgescript/src/structures").BaseCommand<unknown> | null;
    get obj(): Sendable;
    get args(): string[];
    get states(): import("@tryforge/forgescript/src/core/Interpreter").States | undefined;
    ...
    private error;
    get getExtension(): {
        <B extends boolean>(name: string, required?: B | undefined): B extends true ? import("@tryforge/forgescript/src/structures").ForgeExtension : import("@tryforge/forgescript/src/structures").ForgeExtension | null;
