import { ICompiledFunctionConditionField, ICompiledFunctionField, ICompiledFunction } from "@tryforge/forgescript/src/core";
import { ErrorType, GetErrorArgs } from "@tryforge/forgescript/src/structures/forge/ForgeError";
import { Context } from "@tryforge/forgescript/src/structures/@internal/Context";
import { IArg, UnwrapArgs, NativeFunction, ArgType } from "@tryforge/forgescript/src/structures/@internal/NativeFunction";
import { Return, ReturnType, ReturnValue } from "@tryforge/forgescript/src/structures/@internal/Return";
...
export declare class CompiledFunction<T extends [...IArg[]] = IArg[], Unwrap extends boolean = boolean> {
    ...
    getFunction(fieldIndex: number, ref: NativeFunction): CompiledFunction<IArg<ArgType, boolean, boolean, import("@tryforge/forgescript/src/structures/@internal/NativeFunction").EnumLike<any>>[], boolean> | undefined;
    getFunctions(fieldIndex: number, ref: NativeFunction): CompiledFunction<IArg<ArgType, boolean, boolean, import("@tryforge/forgescript/src/structures/@internal/NativeFunction").EnumLike<any>>[], boolean>[];
