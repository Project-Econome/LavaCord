import { ArgType, IArg, INativeFunction, NativeFunction } from "@tryforge/forgescript/src/structures/@internal/NativeFunction";
import { IRawFunction } from "@tryforge/forgescript/src/core";
...
export declare class FunctionManager {
    ...
    static reload(): void;
    static get(name: string): NativeFunction<IArg<ArgType, boolean, boolean, import("@tryforge/forgescript/src/structures/@internal/NativeFunction").EnumLike<any>>[], boolean>;
