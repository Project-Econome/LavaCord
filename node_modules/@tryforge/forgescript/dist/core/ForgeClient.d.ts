...
import { IExtendedCompilationResult } from "@tryforge/forgescript/src/core";
import { NativeCommandManager, EventManager, CooldownManager, ForgeFunctionManager, ApplicationCommandManager, ThreadManager, BaseCommandManager } from "@tryforge/forgescript/src/managers";
import { CommandType, LogPriority, ForgeExtension, ClassType, ClassInstance, BaseCommand } from "@tryforge/forgescript/src/structures";
